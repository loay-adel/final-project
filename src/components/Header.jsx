...
import {
  ...
  logout,
  getCurrentUser,
} from "../components/authentucation/auth";
    ...
    <Navbar fullWidth className="lg:px-8 lg:py-4 mx-auto px-4 py-2">
      <div className="container flex flex-wrap justify-between text-black items-center mx-auto">
        ...
        <div className="gap-x-2 hidden items-center lg:flex">
          ...
          {/* Always show profile icon, change behavior based on login status */}
          <Menu>
            <MenuHandler>
              <div className="flex items-center gap-2 cursor-pointer">
                <Avatar
                  src={loggedIn ? user?.avatar || "/user.png" : "/user.png"}
                  alt="avatar"
                  size="sm"
                />
                ...
                <MenuItem className="flex items-center gap-2">
                  <svg
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M16 8C16 10.1217 15.1571 12.1566 13.6569 13.6569C12.1566 15.1571 10.1217 16 8 16C5.87827 16 3.84344 15.1571 2.34315 13.6569C0.842855 12.1566 0 10.1217 0 8C0 5.87827 0.842855 3.84344 2.34315 2.86683C3.84344 1.99167 5.87827 1.5 8 1.5C10.1217 1.5 12.1566 1.99167 13.6569 2.86683C15.1571 3.84344 16 5.87827 16 8ZM10 5C10 5.53043 9.78929 6.03914 9.41421 6.41421C9.03914 6.78929 8.53043 7 8 7C7.46957 7 6.96086 6.78929 6.58579 6.41421C6.21071 6.03914 6 5.53043 6 5C6 4.46957 6.21071 3.96086 6.58579 3.58579C6.96086 3.21071 7.46957 3 8 3C8.53043 3 9.03914 3.21071 9.41421 3.58579C9.78929 3.96086 10 4.46957 10 5ZM8 9C7.0426 8.99981 6.10528 9.27449 5.29942 9.7914C4.49356 10.3083 3.85304 11.0457 3.454 11.916C4.01668 12.5706 4.71427 13.0958 5.49894 13.4555C6.28362 13.8152 7.13681 14.0009 8 14C8.86319 14.0009 9.71638 13.8152 10.5011 13.4555C11.2857 13.0958 11.9833 12.5706 12.546 11.916C12.147 11.0457 11.5064 10.3083 10.7006 9.7914C9.89472 9.27449 8.9574 8.99981 8 9Z"
                      fill="#90A4AE"
                    />
                  </svg>
                  <Typography
